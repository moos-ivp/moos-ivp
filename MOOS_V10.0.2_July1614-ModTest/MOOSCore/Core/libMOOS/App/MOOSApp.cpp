                    ...
                    const std::string & sMissionFile)
{
	...
	if(m_SuicidalSleeper.UsingDefaultPort())         // Added by mikerb sep14
	  m_SuicidalSleeper.SetPort(m_lServerPort);
	
	cout << "Hello!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!" << endl;
	cout << "m_lServerPort: " << m_lServerPort << endl;
	cout << "Using: " << m_SuicidalSleeper.UsingDefaultPort() << endl;
	cout << "Bye!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!" << endl;
...
#if 1  // Disabled here by mikerb sep14. Delay until after comms configured
...
#if 0  // Disabled here by mikerb sep14. Delay until after comms configured
    //are we being told to disable suicide?
    if(!GetFlagFromCommandLineOrConfigurationFile("moos_suicide_disable"))
    {
