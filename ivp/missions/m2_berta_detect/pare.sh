...
PARE_LIST="BHV_IPF,VIEW_SEGLIST,DESIRE_RUDDER,DESIRED_THRUST,NAV_HEADING_OVER_GROUND,IVPHELM_SUMMARY,IVPHELM_CPU,IVPHELM_CREATE_CPU"
HIT_LIST="*ITER_GAP,*ITER_LEN,PSHARE*,NODE_REPORT*,DB_QOS,DB_CLIENTS,IVPHELM_ALLSTOP_DEBUG,NODE_BROKER_PING_0,NODE_BROKER_ACK"
RMORIG="no"
ALL_OK="yes"
