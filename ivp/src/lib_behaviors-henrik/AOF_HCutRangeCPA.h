...
#ifndef AOF_HCUTRANGE_CPA_HEADER
#define AOF_HCUTRANGE_CPA_HEADER

#include "AOF.h"
#include "CPAEngine.h"

class AOF_HCutRangeCPA: public AOF {
public:
  AOF_HCutRangeCPA(IvPDomain);
  ~AOF_HCutRangeCPA() {if(cpa_engine) delete(cpa_engine);};
