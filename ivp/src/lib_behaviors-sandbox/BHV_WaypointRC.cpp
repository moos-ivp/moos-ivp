...
BHV_WaypointRC::BHV_WaypointRC(IvPDomain gdomain) : 
  IvPBehavior(gdomain)
{
...
bool BHV_WaypointRC::setParam(string param, string val) 
{
...
IvPFunction *BHV_WaypointRC::onRunState() 
{
...
IvPFunction *BHV_WaypointRC::buildOF(string method) 
{
  IvPFunction *ipf = 0;
...
bool BHV_WaypointRC::setNextWaypoint()
{
  bool ok1, ok2, ok3;
