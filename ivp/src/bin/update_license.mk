...
GPL_RELS  = lib_ivpbuild lib_behaviors-marine lib_helmivp	\
	    lib_mbutil lib_geometry lib_marineview lib_navplot	\
	    pHelmIvP pMarineViewer pTransponderAIS iMarineSim	\
	    pMarinePID pEchoVar app_polyview app_logview uTMS
...
MRB_BETA  = lib_behaviors-colregs lib_behaviors-sandbox     	\
	    ...
	    iMetaCompass lib_xgui pDrone pLoiterControl		\
	    pMarineViewerSim uFunctionViewer uFunctionSender 
