...
/*    FILE: CPXEngineOG.cpp                                      */
/*    DATE: May 12th 2005                                        */
/*    DATE: Jun 24th 2024  Mods to support platmodel version     */
/*    DATE: Oct 26th 2025  Separated from CPXEngineRoot          */
/*                                                               */
...
CPXEngineOG::CPXEngineOG(double cny, double cnx,
			 double cnh, double cnv,
			 double osy, double osx,
			 double osh, double osv)
  : CPXEngine(cny, cnx, cnh, cnv, osy, osx, osh, osv)
{
  CPXEngineOG::reset(cny, cnx, cnh, cnv, osy, osx, osh, osv);
}

//----------------------------------------------------------
// Procedure: reset()

void CPXEngineOG::reset(double cny, double cnx,
			double cnh, double cnv,
			double osy, double osx,
			double osh, double osv)
{
...
double CPXEngineOG::evalROC(double osh, double osv) const
{
...
double CPXEngineOG::bearingRate(double osh, double osv) const
{
...
double CPXEngineOG::evalCPA(double osh, double osv, double ostol) const
{
  if((osh >= 360) || (osh < 0))
    osh = angle360(osh);
...
double CPXEngineOG::evalTimeCPA(double osh, double osv, double ostol) const
{
  if((osh >= 360) || (osh < 0))
    osh = angle360(osh);
...
bool CPXEngineOG::passesPort(double osh, double osv) const
{
  //============================================================
...
double CPXEngineOG::passesPortDist(double osh, double osv) const
{
  double xdist = -1;
  double xtime = -1;
...
double CPXEngineOG::passesPortTime(double osh, double osv) const
{
  double xdist = -1;
  double xtime = -1;
  passesPortDist(osh, osv, xdist, xtime);
...
bool CPXEngineOG::passesStar(double osh, double osv) const
{
  //============================================================
  // Handle Special Cases
  //============================================================
...
double CPXEngineOG::passesStarDist(double osh, double osv) const
{
  double xdist = -1;
  double xtime = -1;
...
double CPXEngineOG::passesStarTime(double osh, double osv) const
{
  double xdist = -1;
  double xtime = -1;
  passesStarDist(osh, osv, xdist, xtime);
...
bool CPXEngineOG::passesStarDist(double osh, double osv,
			       double& xdist, double& xtime) const
{
  // Default return vals reflect ownship does not pass cn starboard
  xdist = -1;
  xtime = -1;
...
bool CPXEngineOG::passesPortOrStar(double osh, double osv) const
{
...
bool CPXEngineOG::crossesStern(double osh, double osv) const
{
...
double CPXEngineOG::crossesSternDist(double osh, double osv) const
{
  double xdist, xtime;
...
double CPXEngineOG::crossesSternTime(double osh, double osv) const
{
  double xdist, xtime;
  crossesSternDist(osh, osv, xdist, xtime);
  return(xtime);
...
bool CPXEngineOG::crossesSternDist(double osh, double osv,
				 double& xdist, double& xtime) const
{
  // Default return values reflect os does not cross stern.
  xdist = -1;
  xtime = -1;
...
bool CPXEngineOG::crossesBow(double osCRS, double osSPD) const
{
  if(m_stat_os_on_sternline)
    return(true);
...
double CPXEngineOG::crossesBowDist(double osh, double osv) const
{
  double xdist, xtime;
...
double CPXEngineOG::crossesBowTime(double osh, double osv) const
{
  double xdist, xtime;
  crossesBowDist(osh, osv, xdist, xtime);
  return(xtime);
...
bool CPXEngineOG::crossesBowDist(double osh, double osv,
			       double& xdist, double& xtime) const
{
...
bool CPXEngineOG::crossesBowOrStern(double osCRS, double osSPD) const
{
...
double CPXEngineOG::osSpdInCNHdgX(double osh, double osv) const
{
  if((osh < 0) || (osh >= 360))
    osh = angle360(osh);
  double v_os_cnh = m_os_cnh_cos_cache[(unsigned int)(osh)] * osv;
...
double CPXEngineOG::osToCNRelBngX(double osh) const
{
  if((osh < 0) || (osh >= 360))
    osh = angle360(osh);
...
double CPXEngineOG::minMaxROC(double speed, double heading_clicks, 
...
double CPXEngineOG::getOSSpeedGamma(double osh, double osv) const
{
  if((osh < 0) || (osh >= 360))
    osh = angle360(osh);
...
double CPXEngineOG::getOSSpeedEpsilon(double osh, double osv) const
{
  if((osh < 0) || (osh >= 360))
    osh = angle360(osh);
  double v_os_cnh = m_os_cnh_cos_cache[(unsigned int)(osh)] * osv;
...
double CPXEngineOG::getOSTimeGamma(double osh, double osv) const
{
...
double CPXEngineOG::getOSTimeEpsilon(double osh, double osv) const
{
  // Sanity check 1: If on the contact, return 0
...
void CPXEngineOG::initRateCache()
{
...
void CPXEngineOG::initOSCNRelBngCache()
{
  vector<double> virgin_cache(360,0);
...
void CPXEngineOG::initOSCNTangentCache()
{
...
void CPXEngineOG::initOSGammaCache()
{
  //---------------------------------------------------------------------
...
void CPXEngineOG::initOSCNHCosCache()
{
