...
void showHelpAndExit()
{
  blk("                                                          ");
  blu("==========================================================");
  blu("Usage: uSimContactRange file.moos [OPTIONS]               ");
  blu("==========================================================");
  blk("                                                          ");
  showSynopsis();
  blk("                                                          ");
  ...
  blk("      Launch uSimContactRange with the given              ");
  blk("      process name rather than uSimContactRange.          ");
  mag("  --example, -e                                           ");
  ...
  mag("  --version,-v                                            ");
  blk("      Display release version of uSimContactRange.        ");
  mag("  --verbose","=<setting>                                  ");
...
void showExampleConfigAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("uSimContactRange Example MOOS Configuration                     ");
  blu("=============================================================== ");
  blk("                                                                ");
...
void showInterfaceAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("uSimContactRange INTERFACE                                      ");
  blu("=============================================================== ");
  blk("                                                                ");
  showSynopsis();
  blk("                                                                ");
  ...
  blk("  SIMCOR_RANGE_REQUEST = name=archie                            ");
  blk("                                                                ");
  blk("PUBLICATIONS:                                                   ");
  blk("------------------------------------                            ");
  blk("  SIMCOR_RANGE_REPORT    = vname=archie,range=126.54,           ");
  blk("                           target=jackal,time=19656022406.44    ");
  blk("  SIMCOR_RANGE_REPORT_GT = vname=archie,range=126.54,           ");
  blk("                           target=jackal,time=19656022406.44    ");
  blk("  SIMCORE_DEBUG          = Invalid incoming node report         ");
