...
#ifndef HELM_TPLOT_HEADER
#define HELM_TPLOT_HEADER
...
public:
  ...
  std::string  getValueByIndex(std::string value_type, 
			       unsigned int index) const;
  std::string  getValueByTime(std::string value_type,
			      double gtime) const;
  std::string  getValueByTimeUTC(std::string value_type,
			      double gtime) const;
