...
void showHelpAndExit()
{
  ...
  cout << "  zaic_peak [OPTIONS]                                " << endl;
  cout << "                                                     " << endl;
  cout << "Synopsis:                                            " << endl;
  cout << "  The zaic_peak utility renders a configured instance" << endl;
  cout << "  of the ZAIC_PEAK utility in the ivpbuild toolbox.  " << endl;
  ...
  cout << "  the very same ZAIC_PEAK C++ class as is used in the" << endl;
  cout << "  behaviors.                                         " << endl;
  cout << "                                                     " << endl;
  cout << "Options:                                             " << endl;
