...
bool CRS_MOOSApp::OnNewMail(MOOSMSG_LIST &NewMail)
{
...
bool CRS_MOOSApp::OnConnectToServer()
{
  RegisterVariables();  
  return(true);
}
...
void CRS_MOOSApp::RegisterVariables()
{
...
void CRS_MOOSApp::postMessages(vector<VarDataPair> msgs)
{
