...
void showInterfaceAndExit()
{
  ...
  blk("  USM_BUOYANCY_RATE     = [-inf,+inf] m/s                       ");
  blk("  USM_ROTATE_SPEED      = [0,inf] m/s                           ");
  blk("  USM_DRIFT_X           = [-inf,+inf] m/s                       ");
  blk("  USM_DRIFT_Y           = [-inf,+inf] m/s                       ");
  blk("  USM_DRIFT_VECTOR      = [0,360),[0,+inf]                      ");
  blk("  USM_DRIFT_VECTOR_ADD  = [-inf,+inf]                           ");
  blk("  USM_DRIFT_VECTOR_MULT = [-inf,+inf]                           ");
