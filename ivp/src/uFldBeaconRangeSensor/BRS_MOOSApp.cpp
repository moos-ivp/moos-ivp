...
bool BRS_MOOSApp::OnNewMail(MOOSMSG_LIST &NewMail)
{
...
bool BRS_MOOSApp::OnConnectToServer()
{
  RegisterVariables();  
  return(true);
}
...
void BRS_MOOSApp::RegisterVariables()
{
...
void BRS_MOOSApp::postMessages(vector<VarDataPair> msgs)
{
