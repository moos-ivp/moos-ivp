...
#ifndef AOF_WPT3D_HEADER
#define AOF_WPT3D_HEADER

#include "AOF.h"
#include "IvPDomain.h"

class AOF_WPT3D: public AOF {
 public:
  AOF_WPT3D(IvPDomain);
  ~AOF_WPT3D() {};
...
protected:
  double os_lat;   // Ownship Lat position at time Tm.
  double os_lon;   // Ownship Lon position at time Tm.
  double pt_lat;   
  double pt_lon;  
  double desired_spd;
