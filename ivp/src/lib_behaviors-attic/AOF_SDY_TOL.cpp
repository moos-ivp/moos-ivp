...
/*    FILE: AOF_SDY_TOL.cpp                                      */
/*    DATE: March 21st, 2001                                     */
/*****************************************************************/
 
#include <math.h>
#include <string>
#include "AOF_SDY_TOL.h"
...
AOF_SDY_TOL::AOF_SDY_TOL(IvPDomain gdomain) : AOF(gdomain)
{
...
bool AOF_SDY_TOL::setParam(const string& param, double param_val)
{
...
double AOF_SDY_TOL::evalBox(const IvPBox *b) const
{
  double eval_crs = 0;
