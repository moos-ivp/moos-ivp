...
#if 0
  np_viewer = new NavPlotViewer(0, 30, w()/2, h()-350);
  cmviewer = np_viewer;
...
#if 1
  np_viewer = new NavPlotViewer(0, 30, w()/2, h()-200);
  cmviewer = np_viewer;
...
#if 1
  ipf_viewer = new IvPFuncViewer(w()/2, 30, w()/2, h()-200);
  ipf_viewer_b = 0;
#endif

#if 0
  ipf_viewer = new IvPFuncViewer(270, 40, 220, 160);
  ipf_viewer_b = new IvPFuncViewer(270, 200, 220, 160);
#endif
...
void REPLAY_GUI::augmentMenu()
{
  ...
  mbar->add("IPF_PLOT/Increment", 0, (Fl_Callback*)REPLAY_GUI::cb_AltIndexIPF, (void*)1, 0);
  mbar->add("IPF_PLOT/Decrement", 0, (Fl_Callback*)REPLAY_GUI::cb_AltIndexIPF, (void*)-1, 0);

  mbar->add("Pan-Zoom/Rotate X- ", FL_CTRL+FL_Down,  (Fl_Callback*)REPLAY_GUI::cb_RotateX, (void*)-1, 0);
  mbar->add("Pan-Zoom/Rotate X+ ", FL_CTRL+FL_Up,  (Fl_Callback*)REPLAY_GUI::cb_RotateX, (void*)1, 0);
  mbar->add("Pan-Zoom/Rotate Z- ", FL_CTRL+FL_Left,  (Fl_Callback*)REPLAY_GUI::cb_RotateZ, (void*)-1, 0);
  mbar->add("Pan-Zoom/Rotate Z+ ", FL_CTRL+FL_Right,  (Fl_Callback*)REPLAY_GUI::cb_RotateZ, (void*)1, FL_MENU_DIVIDER);
  mbar->add("Pan-Zoom/Reset 1",         0,  (Fl_Callback*)REPLAY_GUI::cb_Reset, (void*)1, 0);
  mbar->add("Pan-Zoom/Reset 2",         0,  (Fl_Callback*)REPLAY_GUI::cb_Reset, (void*)2, 0);
  mbar->add("Pan-Zoom/Reset 3",         0,  (Fl_Callback*)REPLAY_GUI::cb_Reset, (void*)3, FL_MENU_DIVIDER);
  mbar->add("Pan-Zoom/Expand Radius ",  0,  (Fl_Callback*)REPLAY_GUI::cb_StretchRad, (void*)1, 0);
  mbar->add("Pan-Zoom/Shrink Radius ",  0,  (Fl_Callback*)REPLAY_GUI::cb_StretchRad, (void*)-1, FL_MENU_DIVIDER);
};
...
inline bool REPLAY_GUI::cb_Step_i(int val) {
  ...
  if(changed) { 
    ...
    ipf_viewer->set_curr_time(curr_time);
    ipf_viewer->redraw();
    if(ipf_viewer_b) {
      ipf_viewer_b->set_curr_time(curr_time);
      ipf_viewer_b->redraw();
    }
  }
  return(changed);
...
//----------------------------------------- AltIndexIPF
inline void REPLAY_GUI::cb_AltIndexIPF_i(int val) {
  ipf_viewer->altPlotIndex(val);
  double curr_time = np_viewer->getCurrTime();
  ipf_viewer->set_curr_time(curr_time);
  ipf_viewer->redraw();
}

void REPLAY_GUI::cb_AltIndexIPF(Fl_Widget* o, int val) {
  ((REPLAY_GUI*)(o->parent()->user_data()))->cb_AltIndexIPF_i(val);
}
...
void REPLAY_GUI::cb_RotateX(Fl_Widget* o, int v) {
  ((REPLAY_GUI*)(o->parent()->user_data()))->cb_RotateX_i(v);
}
...
void REPLAY_GUI::cb_RotateZ(Fl_Widget* o, int v) {
  ((REPLAY_GUI*)(o->parent()->user_data()))->cb_RotateZ_i(v);
}
...
void REPLAY_GUI::cb_Reset(Fl_Widget* o, int v) {
  ((REPLAY_GUI*)(o->parent()->user_data()))->cb_Reset_i(v);
}
...
void REPLAY_GUI::cb_StretchRad(Fl_Widget* o, int v) {
  ((REPLAY_GUI*)(o->parent()->user_data()))->cb_StretchRad_i(v);
}
