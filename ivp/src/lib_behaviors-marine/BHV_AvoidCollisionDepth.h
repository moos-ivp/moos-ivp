...
#ifndef BHV_AVOID_COLLISION_DEPTH_HEADER
#define BHV_AVOID_COLLISION_DEPTH_HEADER

#include "IvPBehavior.h"
#include "LinearExtrapolator.h"

class IvPDomain;
class BHV_AvoidCollisionDepth : public IvPBehavior {
public:
  BHV_AvoidCollisionDepth(IvPDomain);
  ~BHV_AvoidCollisionDepth() {};
