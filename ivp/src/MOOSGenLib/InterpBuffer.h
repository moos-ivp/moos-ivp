...
public:
    void SetInterpFunc(const InterpFunc &interp) {m_linearinterp = interp;}
    InterpFunc &GetInterpFunc() {return m_linearinterp; }
...
//!INterfunction for use with InterpBuffer
