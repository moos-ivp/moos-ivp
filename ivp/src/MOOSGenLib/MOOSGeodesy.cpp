							...
							double &UTMEasting, char *UTMZone)
{
	...
	sprintf(UTMZone, "%d%c\0", ZoneNumber, UTMLetterDesignator(Lat));
...
double CMOOSGeodesy::DecDeg2DecMin(double dfDecDeg)
{
	int nDeg = (int)dfDecDeg;

	double dfDecMin = (dfDecDeg - (double)nDeg) * 60.0;
