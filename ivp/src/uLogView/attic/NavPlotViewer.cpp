...
void NavPlotViewer::addLogPlotHDG(const LogTPlot& lp)
{
...
void NavPlotViewer::addVPlugPlot(const VPlugTPlot& gp)
{
...
void NavPlotViewer::setCurrTime(double gtime)
{
  ...
  m_pbuffer.pushPending("ALOGVIEW_TIME", gtime);
}
...
void NavPlotViewer::drawNavPlot(unsigned int index)
{
  ...
  string    vehi_type   = "uuv";
  double    vehi_length = 5 * shape_scale;
  string    vehi_name   = "billy";
