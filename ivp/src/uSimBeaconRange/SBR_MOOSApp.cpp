...
bool SBR_MOOSApp::OnNewMail(MOOSMSG_LIST &NewMail)
{
...
bool SBR_MOOSApp::OnConnectToServer()
{
  RegisterVariables();  
  return(true);
}
...
void SBR_MOOSApp::RegisterVariables()
{
  m_Comms.Register("NODE_REPORT", 0);
  m_Comms.Register("NODE_REPORT_LOCAL", 0);
  m_Comms.Register("SBR_RANGE_REQUEST", 0);
}
