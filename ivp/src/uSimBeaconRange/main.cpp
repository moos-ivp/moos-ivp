...
int main(int argc, char *argv[])
{
  ...
  if((mission_file == "") || help_requested) {
    cout << "Usage: uSimBeaconRange file.moos [OPTIONS]             " << endl;
    cout << "                                                       " << endl;
    cout << "Options:                                               " << endl;
    ...
    cout << "  --version,-v                                         " << endl;
    cout << "      Display the release version of uSimBeaconRange.  " << endl;
    return(0);
  }

  cout << termColor("green");
  cout << "uSimBeaconRange running as: " << run_command << endl;
  cout << termColor() << endl;

  SBR_MOOSApp sim_beacon_range;
