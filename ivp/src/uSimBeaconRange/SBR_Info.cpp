...
void showHelpAndExit()
{
  blk("                                                          ");
  blu("==========================================================");
  blu("Usage: uSimBeaconRange file.moos [OPTIONS]                ");
  blu("==========================================================");
  blk("                                                          ");
  showSynopsis();
  blk("                                                          ");
  ...
  blk("      Launch uSimBeaconRange with the given process name  ");
  blk("      rather than uSimBeaconRange.                        ");
  mag("  --example, -e                                           ");
  ...
  mag("  --version,-v                                            ");
  blk("      Display release version of uSimBeaconRange.         ");
  mag("  --verbose","=<setting>                                  ");
...
{
  blu("=============================================================== ");
  blu("uSimBeaconRange Example MOOS Configuration                      ");
  blu("=============================================================== ");
  blk("{                                                               ");
  blk("  AppTick   = 4                                                 ");
  blk("  CommsTick = 4                                                 ");
...
void showInterfaceAndExit()
{
  ...
  blk("  SBR_RANGE_REQUEST = name=archie                               ");
  blk("                                                                ");
  blk("PUBLICATIONS:                                                   ");
  blk("------------------------------------                            ");
  blk("  SBR_RANGE_REPORT    = vname=alpha,range=26.54,                ");
  blk("                        time=19656022406.44                     ");
  blk("  SBR_RANGE_REPORT_GT = vname=archie,range=126.54,              ");
  blk("                        time=19656022406.44                     ");
  blk("  SBR_DEBUG           = Invalid incoming node report            ");
...
{
  showReleaseInfo("uSimBeaconRange", "gpl");
  exit(0);
}
