...
// ----------------------------------------------------------
// Procedure: push_new_contact
//   Purpose: 

void BNG_Model::push_new_contact()
{
...
bool BNG_Model::initFromFile(std::string filename)
{
  if(size() == 0)
    push_new_contact();
...
void BNG_Model::shift_os_maxspd(double v)
{
  m_os_maxspd += v/10;
  if(m_os_maxspd < 0)
    m_os_maxspd = 0;
...
void BNG_Model::shift_os_maxtol(double v)
{
  m_os_maxtol += v;
  if(m_os_maxtol < 5)
    m_os_maxtol = 5;
...
void BNG_Model::set_cnx(double val, unsigned int index)
{
  if(index >= m_cnx.size())
    return;
  m_cnx[index] = val;
...
void BNG_Model::set_cny(double val, unsigned int index)
{
  if(index >= m_cny.size())
    return;
  m_cny[index] = val;
...
void BNG_Model::set_cnspd(double val, unsigned int index)
{
...
void BNG_Model::set_cncrs(double val, unsigned int index)
{
...
void BNG_Model::set_cnrng(double val, unsigned int index)
{
  if(index >= m_cncrs.size())
    return;
...
void BNG_Model::set_cnbng(double val, unsigned int index)
{
  if(index >= m_cncrs.size())
    return;
...
void BNG_Model::shift_cnx(double val, unsigned int index)
{
  if(index >= m_cnx.size())
    return;
  m_cnx[index] += val;
...
void BNG_Model::shift_cny(double val, unsigned int index)
{
  if(index >= m_cny.size())
    return;
  m_cny[index] += val;
...
void BNG_Model::shift_cnspd(double val, unsigned int index)
{
  if(index >= m_cnspd.size())
    return;
...
void BNG_Model::shift_cncrs(double val, unsigned int index)
{
  if(index >= m_cncrs.size())
    return;
  m_cncrs[index] += val;
...
void BNG_Model::shift_range(double val, unsigned int index)
{
  if(index >= m_cncrs.size())
    return;
...
void BNG_Model::set_cn_range_bearing(string str, unsigned int index)
{
  if(index >= m_cnx.size())
    return;
...
double BNG_Model::get_param(const string& param, 
...
IvPFunction *BNG_Model::calc_cpa_ipf(unsigned int ix, 
...
IvPFunction *BNG_Model::calc_wpt_ipf(unsigned int ix, 
				     unsigned int unif_units)
{
  if(ix >= this->size())
    return(0);
...
IvPFunction *BNG_Model::calc_spt_ipf(unsigned int ix, 
				     unsigned int unif_units)
{
  if(ix >= this->size())
    return(0);
...
IvPFunction *BNG_Model::calc_avd_ipf(unsigned int ix, 
				     unsigned int unif_units)
{
  if(ix >= this->size())
    return(0);
...
IvPFunction *BNG_Model::calc_roc_ipf(unsigned int ix, 
				     unsigned int unif_units)
{
  if(ix >= this->size())
    return(0);
...
IvPFunction *BNG_Model::calc_r16_ipf(unsigned int ix, 
				     unsigned int unif_units)
{
  if(ix >= this->size())
    return(0);
...
vector<double> BNG_Model::extrapolate(double g_spd, double g_time, 
