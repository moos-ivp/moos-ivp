...
/*    FILE: CommonEncounterViewer.cpp                            */
/*    DATE: Jan 11th, 2016                                       */
/*                                                               */
...
#include <iostream>
#include <cstring>
#include "CommonEncounterViewer.h"
#include "GeomUtils.h"
#include "MBUtils.h"
...
CommonEncounterViewer::CommonEncounterViewer(int g_x, int g_y,
					     int g_width, 
					     int g_height,
					     const char *g_l)
...
void CommonEncounterViewer::resize(int x, int y, int wid, int hgt)
{
...
int CommonEncounterViewer::handle(int event)
{
...
bool CommonEncounterViewer::setParam(string param, string value)
{
...
bool CommonEncounterViewer::setParam(string param, double value)
{
...
void CommonEncounterViewer::printParams()
{
  cout << "# lib_ipfview CommonEncounterViewer -----------------" << endl;
...
void CommonEncounterViewer::clear()
{
...
void CommonEncounterViewer::draw()
{
  clear();
...
bool CommonEncounterViewer::drawIvPFunction()
{
...
void CommonEncounterViewer::drawIvPFunction1D()
{
  double clear_red = m_clear_color.red();
  double clear_grn = m_clear_color.grn();
  double clear_blu = m_clear_color.blu();
...
bool CommonEncounterViewer::drawIvPFunction2D()
{
...
void CommonEncounterViewer::drawQuad(Quad3D q, double rad_extra_extra)
{
...
void CommonEncounterViewer::drawFrame(bool full)
{
  double w = 300;
...
void CommonEncounterViewer::drawOwnPoint()
{
...
void CommonEncounterViewer::drawMaxPoint(double crs, double spd)
{
  if(m_quadset.size2D() == 0)
    return;
...
void CommonEncounterViewer::draw1DAxes(const IvPDomain& domain)
{
  glMatrixMode(GL_PROJECTION);
  glLoadIdentity();
  glOrtho(0, w(), 0, h(), -1 ,1);
...
void CommonEncounterViewer::draw1DKeys(vector<string> key_strings, 
				  vector<ColorPack> key_colors)
{
...
void CommonEncounterViewer::draw1DLine(double val, string label)
{
...
void CommonEncounterViewer::draw1DLineX(double value, 
				   string label,
				   int offset,
				   ColorPack cpack)
{
...
void CommonEncounterViewer::drawText(int x, int y, string str)
{
  if(x<0) x=0;
  if(y<0) y=0;
