...
#ifndef COMMON_ENCOUNTER_VIEWER_HEADER
#define COMMON_ENCOUNTER_VIEWER_HEADER
...
class CommonEncounterViewer : public Fl_Gl_Window
{
 public:
  CommonEncounterViewer(int x,int y,int w,int h,const char *l=0);
  virtual ~CommonEncounterViewer() {}
