...
public:
  ...
  int    size() {return(m_start_x.size());};
...
protected:
  std::vector<double>  m_start_x;
  std::vector<double>  m_start_y;
  std::vector<double>  m_start_spd;
  std::vector<double>  m_start_hdg;
  std::vector<double>  m_dest_x;
  std::vector<double>  m_dest_y;
};
