...
#else
    void * Result;
    pthread_join(m_nWDThreadID,&Result);
#endif
...
bool CMOOSRemote::StartThreads()
{
    ...
    int Status = pthread_create(& m_nWDThreadID,NULL,WDLoopProc,this);
    ...
    Status = pthread_create(& m_nMailThreadID,NULL,MailLoopProc,this);
...
bool CMOOSRemote::Run( char * sName,
					  char * sMissionFile)
{
