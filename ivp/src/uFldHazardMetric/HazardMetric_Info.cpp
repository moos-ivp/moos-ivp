...
void showInterfaceAndExit()
{
  ...
  blk("             label=03,truth=hazard,report=hazard#               ");
  blk("             label=04,truth=hazard,report=nothing,penalty=100#  ");
  blk("             ...                                                ");
  blk("             label=15,truth=benign,report=hazard,penalty=35#    ");
  blk("             label=16,truth=benign,report=hazard,penalty=35#    ");
