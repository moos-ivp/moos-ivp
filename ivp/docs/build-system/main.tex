...
% \begin{figure}[h]
% \centerline{
% % 	\epsfig{file=file-structure, scale=0.5}
% 	\psfig{figure=file-structure.ps,width=5in};
% }
...
\begin{figure}
 \centering
%  \includegraphics{file-structure.pdf}

\includegraphics{file-structure.eps}
 % file-structure.eps: 1179666x1179666 pixel, 300dpi, 9987.84x9987.84 cm, bb=0 0 595 842
 \caption{My Caption}
 \label{fig:foo}
\end{figure}


% \epsfig{file-structure.eps}
% \includegraphics{file-structure}
% \includegraphics[type=eps,ext=.eps,read=.eps]{file-structure}
% \includegraphics[type=fig,ext=.fig,read=.fig]{file-structure}
