...
\img[width=\linewidth]{figures/searcharea}{A geographic area (a convex polygon) defined as a search area.}{fig_searcharea}

\img[width=\linewidth]{figures/searchgrid}{A search grid defined over a search area.}{fig_searchgrid}
