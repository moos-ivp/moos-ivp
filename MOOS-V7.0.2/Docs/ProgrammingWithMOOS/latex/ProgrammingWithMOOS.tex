...
\lstinputlisting[basicstyle=\footnotesize, caption = {A modified simulator application which reads configuration iformation from its mission file.},label = {Code:Ex4:Simulator.cpp}
