...
(setq moos-app-and-keyword-list
      ...
      '("pHelmIvP" "goals_mandatory" "term_report_interval" "ivp_behavior_dir" "behaviors" "domain" "start_engaged" "allow_disengaged" "disengage_on_allstop" "other_override_var" "node_skew" "ok_skew" "verbose" "bhv_dir_not_found_ok" "start_in_drive" "kcache" "hold_on_apps" "max_appcast_events" "helm_prefix" "hold_on_app" "park_on_allstop" "nav_grace" )
