...
(setq moos-app-and-keyword-list
      ...
      '("uTermCommand" "cmd")
      '("pNodeReporter" "platform_type" "platform_length" "blackout_interval" "plat_report_input" "plat_report_output" "node_report_output" "nohelm_threshold" "crossfill_policy" "alt_nav_prefix" "alt_nav_name" "vessel_type" "group" "paused" "terse_reports" "platform_color" "max_appcast_events" "platform_group" "alt_nav_group" "nav_grace_periode" "app_logging" "allow_color_change" "extrap_enabled" "extrap_pos_thresh" "extrap_hdg_thres" "extrap_max_gap" "extrap_hdg_thres" "nav_grace_period" )
