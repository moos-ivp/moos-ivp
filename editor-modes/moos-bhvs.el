...
(setq moos-bhv-and-keyword-list
      (list
       ...
       '("BHV_Loiter" "acquire_dist" "capture_radius" "center_activate" "center_assign" "clockwise" "polygon" "post_suffix" "radius" "nm_radius" "slip_radius" "speed" "spiral_factor" "visual_hints" "xcenter_assigne" "ycenter_assign")
