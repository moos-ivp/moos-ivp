...
(setq moos-bhv-and-keyword-list
      (list
       '("BHV_AvdColregsV17" "post_mapping" "pwt_outer_dist" "pwt_inner_dist" "completed_dist" "min_util_cpa_dist" "max_util_cpa_dist" "turn_radius" "avoid_mode" "avoid_submode" "no_alert_request" "contact_type_required" "pwt_grade" "bearing_line_config" "contact" "on_no_contact_ok" "extrapolate" "decay" "match_type" "ignore_type" "match_group" "ignore_group" "match_name" "ignore_name" "match_region" "ignore_region" "exit_on_filter_vname" "exit_on_filter_vtype" "exit_on_filter_group" "exit_on_filter_region" "post_per_contact_info")

       '("BHV_AvdColregsV19" "post_mapping" "pwt_outer_dist" "pwt_inner_dist" "completed_dist" "min_util_cpa_dist" "max_util_cpa_dist" "turn_radius" "avoid_mode" "avoid_submode" "no_alert_request" "contact_type_required" "pwt_grade" "giveway_bow_dist" "use_refinery" "check_plateaus" "check_validity" "pcheck_thresh" "bearing_line_config" "contact" "on_no_contact_ok" "extrapolate" "decay" "match_type" "ignore_type" "match_group" "ignore_group" "match_name" "ignore_name" "match_region" "ignore_region" "exit_on_filter_vname" "exit_on_filter_vtype" "exit_on_filter_group" "exit_on_filter_region" "can_disable" "post_per_contact_info")

       '("BHV_AvdColregsV22" "post_mapping" "pwt_outer_dist" "pwt_inner_dist" "completed_dist" "min_util_cpa_dist" "max_util_cpa_dist" "turn_radius" "avoid_mode" "avoid_submode" "no_alert_request" "contact_type_required" "pwt_grade" "giveway_bow_dist" "use_refinery" "check_plateaus" "check_validity" "pcheck_thresh" "bearing_line_config" "contact" "on_no_contact_ok" "extrapolate" "decay" "match_type" "ignore_type" "match_group" "ignore_group" "match_name" "ignore_name" "match_region" "ignore_region" "exit_on_filter_vname" "exit_on_filter_vtype" "exit_on_filter_group" "exit_on_filter_region" "headon_only" "velocity_filter" "bearing_line_show" "bearing_line_label_show" "can_disable" "post_per_contact_info" )
       ...
       '("BHV_Convoy" "post_mapping" "contact" "radius" "nm_radius" "max_mark_range" "cruise_speed" "spd_max" "spd_slower" "spd_faster" "rng_estop" "range_estop" "rng_tgating" "range_tailgating" "rng_lagging" "range_lagging" "inter_mark_range" "post_per_contact_info")

       '("BHV_ConvoyV21" "post_mapping" "contact" "post_recap_verbose" "radius" "capture_radius" "slip_radius" "inter_mark_range" "tail_length_max" "full_stop_convoy_range" "slower_convoy_range" "ideal_convoy_range" "faster_convoy_range" "full_lag_convoy_range" "lag_speed_delta" "convoy_flag" "marker_flag" "visual_hints" "patience" "aft_patience" "post_per_contact_info")
       ...
       '("BHV_OpRegionV24" "max_time" "max_depth" "min_altitude" "polygon" "trigger_entry_time" "trigger_exit_time" "visual_hints" "breached_altitude_flag" "breached_depth_flag" "breached_poly_flag" "breached_time_flag" "core_poly" "save_poly" "halt_poly" "draw_halt_status" "draw_save_statue" "save_flag" "savex_flag" "halt_dist" "save_dist" "dynamic_region_var" "recover_spd" "recover_speed" "draw_path_loop" "allstop_ttc" "allstop_range" )
       ...
       '("BHV_AvoidObstacleV24" "post_mapping" "poly" "allowable_ttc" "pwt_outer_dist" "pwt_inner_dist" "min_util_cpa_dist" "max_util_cpa_dist" "obstacle_key" "completed_dist" "no_alert_request" "use_refinery" "id" "visual_hints" "allstop_on_breach" "can_disable" "holonomic_ok")
       '("BHV_HSLine" "post_mapping" "time_on_leg" )
       '("BHV_TestFailure" "post_mapping" "failure_type")
       '("BHV_CutRange" "post_mapping" "contact" "them" "extrapolate" "decay" "decay_end" "time_on_leg" "bearing_line_config" "pwt_outer_dist" "pwt_inner_dist" "giveup_dist" "patience" "on_no_contact_ok" "pursueflag" "giveupflag" "match_type" "ignore_type" "match_group" "ignore_group" "match_name" "ignore_name" "match_region" "ignore_region" "exit_on_filter_vname" "exit_on_filter_vtype" "exit_on_filter_group" "exit_on_filter_region" "post_per_contact_info")
       '("BHV_Shadow" "post_mapping" "contact" "them" "extrapolate" "decay" "decay_end" "time_on_leg" "bearing_line_config" "pwt_outer_dist" "heading_peakwidth" "heading_basewidth" "speed_peakwidth" "speed_basewidth" "on_no_contact_ok" "match_type" "ignore_type" "match_group" "ignore_group" "match_name" "ignore_name" "match_region" "ignore_region" "exit_on_filter_vname" "exit_on_filter_vtype" "exit_on_filter_group" "exit_on_filter_region" "post_per_contact_info")
       '("BHV_Trail" "post_mapping" "contact" "them" "extrapolate" "decay" "decay_end" "time_on_leg" "bearing_line_config" "nm_radius" "n_alert_request" "post_trail_dist_on_idle" "pwt_outer_dist" "radius" "trail_angle" "trail_angle_type" "trail_range" "on_no_contact_ok" "exit_on_filter_vname" "exit_on_filter_vtype" "exit_on_filter_group" "exit_on_filter_region" "post_per_contact_info")
